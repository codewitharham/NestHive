    ...
    const Footer = () => {
        ...
        return (
            <>
                <footer className="bg-gradient-to-b from-blue-50 to-sky-100 dark:to-transparent dark:from-sky-950 relative  ">
                    <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 z-10 relative">
                        <Link href="#" className="inline-flex justify-between items-center py-1 px-1 pe-4 mb-7 text-sm text-blue-700 bg-blue-100 rounded-full dark:bg-blue-900 dark:text-blue-300 hover:bg-blue-200 dark:hover:bg-blue-800">
                        ...
                        Build and ship software on a single, collaborative platform</h1>
                        <p className="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 lg:px-48 dark:text-gray-200">Here at Join the world’s most widely adopted AI-powered developer platform.</p>
                    ...
                    <div className="mx-auto w-full max-w-screen-xl p-6 py-6 lg:py-8">
                        <div className="md:flex md:justify-around ">
                            <div className="mb-6 px-2 md:mb-0">
                                <div className="flex items-center justify-center ">
                                    <Image src={logoSrc} priority={true} height={100} width={100} className=' contrast-[1.8] scale-[3.0] md:scale-[1.9] lg:scale-[3.3] xl:scale-[4.3] object-cover object-center' alt='CodeScience'></Image>
                                </div>
                            </div>
